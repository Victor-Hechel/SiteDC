		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="container-fluid">
					<span class="panel-title">Lista de Notícias</span>
					<div class="pull-right">
						<a href="/admin/Noticias/cadastrar" class="btn btn-default">Cadastrar</a>
					</div>
				</div>
			</div>
			<div id="message">
...
<script type="text/javascript" src="/js/Admin/NoticiasIndex.js"></script>